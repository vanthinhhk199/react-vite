...
import { addAddressInfo, selectAdress } from "../CheckOutSlice";
import "./style.scss";
...
function CheckOut() {
  ...
  const [showAddress, setShowAddress] = useState(false); // State to toggle address section
